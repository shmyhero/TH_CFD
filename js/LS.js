...
var LS = {
  Str:{
    ...
    MORE:['更多','More'],
    GZR:['关注人','FANS'],
    LZSYL:['近2周收益率','2 weeks investment'],
    GZ:['关注','Like'],
    SL:['胜率','WinRate'],
    PCBS:['平仓笔数:','Closed:'],
    //持仓展开详情项
    ...
    TIP_HIGH_IR:['本金需大于','AMOUNT MUST MORE THAN'],
    ...
    ZZJXDY_IR:['本金需大于','AMOUNT MUST MORE THAN'],
    ZZJXXY:['本金 x 杠杆需小于','AMOUNT * MULTIPLIER MUST LESS THAN'],
    ZZJXXY_IR:['本金需小于','AMOUNT MUST LESS THAN'],
    ...
    ALIPAY_ARRIVED:['确认入金','Deposit'],
    UNIONPAY_ARRIVED:['确认入金','Deposit'],
    SXF:['手续费','Fee'],
