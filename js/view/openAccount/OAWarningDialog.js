...
export default class OAWarningDialog extends Component {
  ...
  static defaultProps = {
    proceedCallback: ()=>{},
    messageLines: [
      "根据您在申请过程中提供的有关您的知识、经验和财务状况的信息，我们认为您尚未完全了解差价合约（CFD）交易所涉及的风险和潜在财务成本。因此该投资产品可能不适合您，我们建议您认真考虑是否仍希望继续该申请。",
      "如果在认真考虑之后，您仍希望参与差价合约（CFD）交易，我们建议您在通过模拟交易账户熟悉我们的平台之后，以及查看我们的投资教育资料和产品风险警告提示后再寻求开立实盘账户。您也可寻求相关独立意见。",
      "请记住，差价合约（CFD）交易是杠杆交易，并对您的资本带来高风险，因为价格可能向您不利的方向迅速运动。您的资本面临风险。本产品可能并不适合所有客户，因此您必须确保您了解相关风险。",
